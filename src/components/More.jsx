...
import { BellIcon, ChartIcon, MegaphoneIcon, MapPinIcon, UserIcon, UsersIcon, SignOutIcon, CloseIcon, TimerIcon, BoardIcon, SparkleIcon } from './Icons';
...
const ITEMS = [
  ...
  { tab: 'courses', label: 'Course Planner', hint: 'AI topic breakdown', Icon: SparkleIcon },
